...
void main(List<String> args) async {
  ...
  final hasImageMagic = await _checkImageMagickInstalled();
  if (!hasImageMagic) {
    print(
      'Установите ImageMagic используя "brew install imagemagic" и повторите попытку',
    );
    return;
  }
...
Future<bool> _checkImageMagickInstalled() async {
  try {
